...
RUN buildDeps=( \
	...
	&& curl -SL --connect-timeout 8 --max-time 120 --retry 128 --retry-delay 5 "https://gitlab.com/openconnect/ocserv/-/archive/master/ocserv-master.tar.gz" -o ocserv.tar.xz \
